...
| `/login` | Страница входа | Login + Footer |
...
| **MembershipForm** | Форма подписки | Email input, кнопка Get Started |
| **Login** | Страница входа | Форма авторизации, валидация, кастомный чекбокс |
...
- **useEffect** - загрузка данных из localStorage при монтировании
- **useState** - управление состоянием (слайдер, FAQ, избранное)
- **Композиция компонентов** - переиспользуемые компоненты
...
- [ ] **Страница регистрации** (`/signup`) с валидацией форм
